<?php
	...
	else
	{
		...
		if($flag ===0){
			...
			$Car_EngineNum = "";
			$Car_VinNo = "";
			$sql = "SELECT Car_LicensePlate, Car_EngineNum, Car_VinNo FROM car WHERE Car_ID = ".$car_id;
		...
		//	->setNotificationAlert('')
			->addAndroidNotification($str , $car_title.'有异常', 1, array("Car_ID"=>$car_id, "Car_Title"=>$car_title, "Car_LicensePlate"=>$Car_LicensePlate, "Car_EngineNum"=>$Car_EngineNum, "Car_VinNo"=>$Car_VinNo))
